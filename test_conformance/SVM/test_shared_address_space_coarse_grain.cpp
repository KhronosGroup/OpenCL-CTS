...
{
  return shared_address_space_coarse_grain(deviceID, context, queue, num_elements, CL_FALSE);
}

REGISTER_TEST(svm_shared_address_space_coarse_grain_new_api)
{
  return shared_address_space_coarse_grain(deviceID, context, queue, num_elements, CL_TRUE);
}
