...
int main(int argc, const char *argv[])
{
    test_definition test_list[] = {
        ...
        ADD_TEST_FEATURE(get_sampler_info, F_version_ge(2, 0)),
        ADD_TEST(get_sampler_info_compatibility),
        ADD_TEST_FEATURE(get_command_queue_info, F_version_ge(2, 0)),
        ...
        ADD_TEST_FEATURE(sub_group_dispatch, F_subgroups),
        ADD_TEST_FEATURE(clone_kernel, F_version_ge(2, 1)),
        ADD_TEST_FEATURE(zero_sized_enqueue, F_version_ge(2, 1)),
    };
