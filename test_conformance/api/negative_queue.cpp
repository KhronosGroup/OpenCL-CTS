                                       ...
                                       cl_command_queue queue, int num_elements)
{
    ...
    clCreateCommandQueue(reinterpret_cast<cl_context>(queue), deviceID, 0,
                         &err);
    test_failure_error_ret(
        err, CL_INVALID_CONTEXT,
        "clCreateCommandQueue should return CL_INVALID_CONTEXT when: \"context "
        "is not a valid context\" using a valid object which is not a "
        "cl_context",
        TEST_FAIL);
    ...
    clCreateCommandQueue(context, reinterpret_cast<cl_device_id>(queue), 0,
                         &err);
    test_failure_error_ret(
        err, CL_INVALID_DEVICE,
        "clCreateCommandQueue should return CL_INVALID_DEVICE when: \"device "
        "is not a valid device\" using a valid object which is not a cl_device",
        TEST_FAIL);
                                                       ...
                                                       int num_elements)
{
    ...
    clCreateCommandQueueWithProperties(reinterpret_cast<cl_context>(queue),
                                       deviceID, nullptr, &err);
    test_failure_error_ret(
        err, CL_INVALID_CONTEXT,
        "clCreateCommandQueueWithProperties should return CL_INVALID_CONTEXT "
        "when: \"context is not a valid context\" using a valid object which "
        "is not a cl_context",
        TEST_FAIL);
    ...
    clCreateCommandQueueWithProperties(
        context, reinterpret_cast<cl_device_id>(queue), nullptr, &err);
    test_failure_error_ret(
        err, CL_INVALID_DEVICE,
        "clCreateCommandQueueWithProperties should return CL_INVALID_DEVICE "
        "when: \"device is not a valid device\" using a valid object which is "
        "not a cl_device",
        TEST_FAIL);
                                                   ...
                                                   int num_elements)
{
    ...
    err = clSetDefaultDeviceCommandQueue(reinterpret_cast<cl_context>(deviceID),
                                         deviceID, queue);
    test_failure_error_ret(
        err, CL_INVALID_CONTEXT,
        "clSetDefaultDeviceCommandQueue should return CL_INVALID_CONTEXT when: "
        "\"context is not a valid context\" using a valid object which is not "
        "a context",
        TEST_FAIL);
    ...
    test_failure_error_ret(
        err, CL_INVALID_DEVICE,
        "clSetDefaultDeviceCommandQueue should return CL_INVALID_DEVICE when: "
        "\"device is not a valid device\" using a nullptr",
        TEST_FAIL);

    err = clSetDefaultDeviceCommandQueue(
        context, reinterpret_cast<cl_device_id>(context), queue);
    test_failure_error_ret(
        err, CL_INVALID_DEVICE,
        "clSetDefaultDeviceCommandQueue should return CL_INVALID_DEVICE when: "
    ...
    if (different_device_available(deviceID, &different_device))
    {
        ...
        test_failure_error_ret(
            err, CL_INVALID_DEVICE,
            "clSetDefaultDeviceCommandQueue should return CL_INVALID_DEVICE "
    ...
    test_failure_error_ret(
        ...
        "clSetDefaultDeviceCommandQueue should return CL_INVALID_COMMAND_QUEUE "
        "when: \"command_queue is not a valid command-queue for device\" using "
        "a nullptr",
        TEST_FAIL);

    err = clSetDefaultDeviceCommandQueue(
        context, deviceID, reinterpret_cast<cl_command_queue>(deviceID));
    test_failure_error_ret(
        err, CL_INVALID_COMMAND_QUEUE,
        "clSetDefaultDeviceCommandQueue should return CL_INVALID_COMMAND_QUEUE "
        "when: \"command_queue is not a valid command-queue for device\" using "
        "a valid object which is not a command queue",
        TEST_FAIL);
                                       ...
                                       cl_command_queue queue, int num_elements)
{
    ...
    err = clRetainCommandQueue(reinterpret_cast<cl_command_queue>(context));
    test_failure_error_ret(
        err, CL_INVALID_COMMAND_QUEUE,
        "clRetainCommandQueue should return CL_INVALID_COMMAND_QUEUE when: "
        "\"command_queue is not a valid command-queue\" using a valid object "
                                        ...
                                        int num_elements)
{
    ...
    err = clReleaseCommandQueue(reinterpret_cast<cl_command_queue>(context));
    test_failure_error_ret(
        err, CL_INVALID_COMMAND_QUEUE,
        "clReleaseCommandQueue should return CL_INVALID_COMMAND_QUEUE when: "
        "\"command_queue is not a valid command-queue\" using a valid object "
                                         ...
                                         int num_elements)
{
    ...
    err = clGetCommandQueueInfo(reinterpret_cast<cl_command_queue>(context),
                                CL_QUEUE_CONTEXT, 0, nullptr, nullptr);
    test_failure_error_ret(
        err, CL_INVALID_COMMAND_QUEUE,
        "clGetCommandQueueInfo should return CL_INVALID_COMMAND_QUEUE when: "
        "\"command_queue is not a valid command-queue\" using a valid object "
                                             ...
                                             int num_elements)
{
    ...
    err = clSetCommandQueueProperty(reinterpret_cast<cl_command_queue>(context),
                                    property, CL_TRUE, nullptr);
    test_failure_error_ret(
        err, CL_INVALID_COMMAND_QUEUE,
        "clSetCommandQueueProperty should return CL_INVALID_COMMAND_QUEUE when "
        "\"command_queue is not a valid command-queue\" using a valid object "
        "that is not a command-queue",
        TEST_FAIL);
