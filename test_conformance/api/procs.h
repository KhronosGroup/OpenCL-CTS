...
extern int test_semaphores_import_export_fd(cl_device_id deviceID,
                                            ...
                                            cl_command_queue queue,
                                            int num_elements);
extern int test_semaphores_cross_context_sync_fd_pending(
    cl_device_id deviceID, cl_context context, cl_command_queue defaultQueue,
    int num_elements);
extern int test_semaphores_cross_context_sync_fd_signaled(
    cl_device_id deviceID, cl_context context, cl_command_queue defaultQueue,
    int num_elements);
extern int test_semaphores_import_signaled(cl_device_id deviceID,
                                           cl_context context,
