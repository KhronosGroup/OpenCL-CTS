...
// flag for test verification (good test should discover non-atomic functions
// and fail) #define NON_ATOMIC_FUNCTIONS
...
CorrespondingType host_atomic_fetch_add(volatile AtomicType *a,
                                        CorrespondingType c,
...
template <typename AtomicType, typename CorrespondingType>
CorrespondingType host_atomic_fetch_sub(volatile AtomicType *a,
                                        CorrespondingType c,
                                        TExplicitMemoryOrderType order)
{
#if defined(_MSC_VER) || (defined(__INTEL_COMPILER) && defined(WIN32))
...
template <typename AtomicType, typename CorrespondingType>
CorrespondingType host_atomic_exchange(volatile AtomicType *a,
                                       CorrespondingType c,
                                       TExplicitMemoryOrderType order)
{
#if defined(_MSC_VER) || (defined(__INTEL_COMPILER) && defined(WIN32))
...
template <>
HOST_FLOAT host_atomic_exchange(volatile HOST_ATOMIC_FLOAT *a, HOST_FLOAT c,
                                TExplicitMemoryOrderType order);
template <>
HOST_DOUBLE host_atomic_exchange(volatile HOST_ATOMIC_DOUBLE *a, HOST_DOUBLE c,
                                 TExplicitMemoryOrderType order);
...
template <>
HOST_FLOAT host_atomic_load(volatile HOST_ATOMIC_FLOAT *a,
                            TExplicitMemoryOrderType order);
template <>
HOST_DOUBLE host_atomic_load(volatile HOST_ATOMIC_DOUBLE *a,
                             TExplicitMemoryOrderType order);
...
template <typename AtomicType, typename CorrespondingType>
CorrespondingType host_atomic_fetch_or(volatile AtomicType *a,
                                       CorrespondingType c,
                                       TExplicitMemoryOrderType order)
{
    CorrespondingType expected =
...
template <typename AtomicType, typename CorrespondingType>
CorrespondingType host_atomic_fetch_and(volatile AtomicType *a,
                                        CorrespondingType c,
                                        TExplicitMemoryOrderType order)
{
    CorrespondingType expected =
...
template <typename AtomicType, typename CorrespondingType>
CorrespondingType host_atomic_fetch_xor(volatile AtomicType *a,
                                        CorrespondingType c,
                                        TExplicitMemoryOrderType order)
{
    CorrespondingType expected =
...
template <typename AtomicType, typename CorrespondingType>
CorrespondingType host_atomic_fetch_min(volatile AtomicType *a,
                                        CorrespondingType c,
                                        TExplicitMemoryOrderType order)
{
    CorrespondingType expected =
...
template <typename AtomicType, typename CorrespondingType>
CorrespondingType host_atomic_fetch_max(volatile AtomicType *a,
                                        CorrespondingType c,
                                        TExplicitMemoryOrderType order)
{
    CorrespondingType expected =
...
bool host_atomic_flag_test_and_set(volatile HOST_ATOMIC_FLAG *a,
                                   TExplicitMemoryOrderType order);
void host_atomic_flag_clear(volatile HOST_ATOMIC_FLAG *a,
                            TExplicitMemoryOrderType order);
