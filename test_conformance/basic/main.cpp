...
int main(int argc, const char *argv[])
{
    test_definition test_list[] = {
        ...
        ADD_TEST(image_r8),
        ADD_TEST(barrier),
        ADD_TEST_FEATURE(wg_barrier, F_version_ge(2, 0)),
        ADD_TEST(int2float),
        ADD_TEST(float2int),
        ...
        ADD_TEST_FEATURE(progvar_prog_scope_misc, F_program_scope_variables),
        ADD_TEST_FEATURE(progvar_prog_scope_uninit, F_program_scope_variables),
        ADD_TEST_FEATURE(progvar_prog_scope_init, F_program_scope_variables),
        ADD_TEST_FEATURE(progvar_func_scope, F_program_scope_variables),
