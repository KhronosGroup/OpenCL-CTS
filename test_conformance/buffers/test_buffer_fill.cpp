...
const char *buffer_fill_int_kernel_code[] = {
    ...
    "__kernel void test_buffer_fill_int2(__global int2 *src, __global int2 "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_int4(__global int4 *src, __global int4 "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_int8(__global int8 *src, __global int8 "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_int16(__global int16 *src, __global int16 "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
...
static const char *int_kernel_name[] = {
    "test_buffer_fill_int", "test_buffer_fill_int2", "test_buffer_fill_int4",
    "test_buffer_fill_int8", "test_buffer_fill_int16"
};


const char *buffer_fill_uint_kernel_code[] = {
    "__kernel void test_buffer_fill_uint(__global uint *src, __global uint "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_uint2(__global uint2 *src, __global uint2 "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_uint4(__global uint4 *src, __global uint4 "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_uint8(__global uint8 *src, __global uint8 "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_uint16(__global uint16 *src, __global "
    "uint16 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
...
static const char *uint_kernel_name[] = {
    "test_buffer_fill_uint", "test_buffer_fill_uint2", "test_buffer_fill_uint4",
    "test_buffer_fill_uint8", "test_buffer_fill_uint16"
};


const char *buffer_fill_short_kernel_code[] = {
    "__kernel void test_buffer_fill_short(__global short *src, __global short "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_short2(__global short2 *src, __global "
    "short2 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_short4(__global short4 *src, __global "
    "short4 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_short8(__global short8 *src, __global "
    "short8 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_short16(__global short16 *src, __global "
    "short16 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
...
static const char *short_kernel_name[] = { "test_buffer_fill_short",
                                           "test_buffer_fill_short2",
                                           "test_buffer_fill_short4",
                                           "test_buffer_fill_short8",
                                           "test_buffer_fill_short16" };


const char *buffer_fill_ushort_kernel_code[] = {
    "__kernel void test_buffer_fill_ushort(__global ushort *src, __global "
    "ushort *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_ushort2(__global ushort2 *src, __global "
    "ushort2 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_ushort4(__global ushort4 *src, __global "
    "ushort4 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_ushort8(__global ushort8 *src, __global "
    "ushort8 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_ushort16(__global ushort16 *src, __global "
    "ushort16 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
...
static const char *ushort_kernel_name[] = { "test_buffer_fill_ushort",
                                            "test_buffer_fill_ushort2",
                                            "test_buffer_fill_ushort4",
                                            "test_buffer_fill_ushort8",
                                            "test_buffer_fill_ushort16" };


const char *buffer_fill_char_kernel_code[] = {
    "__kernel void test_buffer_fill_char(__global char *src, __global char "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_char2(__global char2 *src, __global char2 "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_char4(__global char4 *src, __global char4 "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_char8(__global char8 *src, __global char8 "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_char16(__global char16 *src, __global "
    "char16 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
...
static const char *char_kernel_name[] = {
    "test_buffer_fill_char", "test_buffer_fill_char2", "test_buffer_fill_char4",
    "test_buffer_fill_char8", "test_buffer_fill_char16"
};


const char *buffer_fill_uchar_kernel_code[] = {
    "__kernel void test_buffer_fill_uchar(__global uchar *src, __global uchar "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_uchar2(__global uchar2 *src, __global "
    "uchar2 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_uchar4(__global uchar4 *src, __global "
    "uchar4 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_uchar8(__global uchar8 *src, __global "
    "uchar8 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_uchar16(__global uchar16 *src, __global "
    "uchar16 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
...
static const char *uchar_kernel_name[] = { "test_buffer_fill_uchar",
                                           "test_buffer_fill_uchar2",
                                           "test_buffer_fill_uchar4",
                                           "test_buffer_fill_uchar8",
                                           "test_buffer_fill_uchar16" };


const char *buffer_fill_long_kernel_code[] = {
    "__kernel void test_buffer_fill_long(__global long *src, __global long "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_long2(__global long2 *src, __global long2 "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_long4(__global long4 *src, __global long4 "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_long8(__global long8 *src, __global long8 "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_long16(__global long16 *src, __global "
    "long16 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
...
static const char *long_kernel_name[] = {
    "test_buffer_fill_long", "test_buffer_fill_long2", "test_buffer_fill_long4",
    "test_buffer_fill_long8", "test_buffer_fill_long16"
};


const char *buffer_fill_ulong_kernel_code[] = {
    "__kernel void test_buffer_fill_ulong(__global ulong *src, __global ulong "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_ulong2(__global ulong2 *src, __global "
    "ulong2 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_ulong4(__global ulong4 *src, __global "
    "ulong4 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_ulong8(__global ulong8 *src, __global "
    "ulong8 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_ulong16(__global ulong16 *src, __global "
    "ulong16 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
...
static const char *ulong_kernel_name[] = { "test_buffer_fill_ulong",
                                           "test_buffer_fill_ulong2",
                                           "test_buffer_fill_ulong4",
                                           "test_buffer_fill_ulong8",
                                           "test_buffer_fill_ulong16" };


const char *buffer_fill_float_kernel_code[] = {
    "__kernel void test_buffer_fill_float(__global float *src, __global float "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_float2(__global float2 *src, __global "
    "float2 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_float4(__global float4 *src, __global "
    "float4 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_float8(__global float8 *src, __global "
    "float8 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    ...
    "__kernel void test_buffer_fill_float16(__global float16 *src, __global "
    "float16 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
...
static const char *float_kernel_name[] = { "test_buffer_fill_float",
                                           "test_buffer_fill_float2",
                                           "test_buffer_fill_float4",
                                           "test_buffer_fill_float8",
                                           "test_buffer_fill_float16" };
...
static const char *struct_kernel_code =
    ...
    "float    b;\n"
    "} TestStruct;\n"
    "__kernel void read_fill_struct(__global TestStruct *src, __global "
    "TestStruct *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
                            ...
                            int (*fn)(void *, void *, int))
{
    ...
    for (i = 0; i < loops; i++)
    {
        ...
        for (src_flag_id = 0; src_flag_id < NUM_FLAGS; src_flag_id++)
        {
            ...
            // Initialize source buffer with 0, since the validation code
            // expects 0(s) outside of the fill region.
            if (!((flag_set[src_flag_id] & CL_MEM_USE_HOST_PTR)
                  || (flag_set[src_flag_id] & CL_MEM_COPY_HOST_PTR)))
            {
    ...
    for (src_flag_id = 0; src_flag_id < NUM_FLAGS; src_flag_id++)
    {
        ...
        for (n = 0; n < 8; n++)
        {
            ...
            if ((flag_set[src_flag_id] & CL_MEM_USE_HOST_PTR)
                ...
                buffers[0] =
                    clCreateBuffer(context, flag_set[src_flag_id],
                                   ptrSize * num_elements, hostptr, &err);
            else
                buffers[0] = clCreateBuffer(context, flag_set[src_flag_id],
                                            ptrSize * num_elements, NULL, &err);
            if (err)
            {
                print_error(err, " clCreateBuffer failed\n");
            ...
            {
                err = clEnqueueWriteBuffer(queue, buffers[0], CL_FALSE, 0,
                                           ptrSize * num_elements, hostptr, 0,
                                           NULL, NULL);
                if (err != CL_SUCCESS)
                {
                    print_error(err, " clEnqueueWriteBuffer failed\n");
            ...
            buffers[1] = clCreateBuffer(context, CL_MEM_COPY_HOST_PTR,
                                        ptrSize * num_elements, outptr, &err);
            if (!buffers[1] || err)
            {
                print_error(err, " clCreateBuffer failed\n");
                align_free(outptr);
            ...
            /* uncomment for test debugging
             err = clEnqueueWriteBuffer(queue, buffers[0], CL_FALSE, 0, ptrSize
             * num_elements, inptr, 0, NULL, &(event[0]));
             */
            if (err != CL_SUCCESS)
            {
                print_error(err, " clEnqueueFillBuffer failed");
            ...
            err = clEnqueueReadBuffer(queue, buffers[1], CL_FALSE, 0,
                                      ptrSize * num_elements, outptr, 0, NULL,
                                      &(event[1]));
            if (err != CL_SUCCESS)
            {
                print_error(err, " clEnqueueReadBuffer failed");
...
REGISTER_TEST(buffer_fill_int)
{
    ...
    for (n = 0; n < 8; n++)
    {
        ...
        for (i = 0; i < 5; i++)
        {
            ...
            inptr[i] = (cl_int *)align_malloc(ptrSizes[i] * num_elements,
                                              min_alignment);
            memset(inptr[i], 0, ptrSizes[i] * num_elements);
            for (j = ptrSizes[i] * offset_elements / ptrSizes[0];
                 j < ptrSizes[i] * (offset_elements + fill_elements)
                     / ptrSizes[0];
                 ++j)
                inptr[i][j] = TEST_PRIME_INT;

            hostptr[i] = (cl_int *)align_malloc(ptrSizes[i] * num_elements,
                                                min_alignment);
...
REGISTER_TEST(buffer_fill_uint)
{
    ...
    for (n = 0; n < 8; n++)
    {
        ...
        for (i = 0; i < 5; i++)
        {
            ...
            inptr[i] = (cl_uint *)align_malloc(ptrSizes[i] * num_elements,
                                               min_alignment);
            memset(inptr[i], 0, ptrSizes[i] * num_elements);
            for (j = ptrSizes[i] * offset_elements / ptrSizes[0];
                 j < ptrSizes[i] * (offset_elements + fill_elements)
            ...
            hostptr[i] = (cl_uint *)align_malloc(ptrSizes[i] * num_elements,
                                                 min_alignment);
            memset(hostptr[i], 0, ptrSizes[i] * num_elements);
        }
...
REGISTER_TEST(buffer_fill_short)
{
    ...
    for (n = 0; n < 8; n++)
    {
        ...
        for (i = 0; i < 5; i++)
        {
            ...
            inptr[i] = (cl_short *)align_malloc(ptrSizes[i] * num_elements,
                                                min_alignment);
            memset(inptr[i], 0, ptrSizes[i] * num_elements);
            for (j = ptrSizes[i] * offset_elements / ptrSizes[0];
                 j < ptrSizes[i] * (offset_elements + fill_elements)
            ...
            hostptr[i] = (cl_short *)align_malloc(ptrSizes[i] * num_elements,
                                                  min_alignment);
            memset(hostptr[i], 0, ptrSizes[i] * num_elements);
        }
...
REGISTER_TEST(buffer_fill_ushort)
{
    ...
    for (n = 0; n < 8; n++)
    {
        ...
        for (i = 0; i < 5; i++)
        {
            ...
            inptr[i] = (cl_ushort *)align_malloc(ptrSizes[i] * num_elements,
                                                 min_alignment);
            memset(inptr[i], 0, ptrSizes[i] * num_elements);
            for (j = ptrSizes[i] * offset_elements / ptrSizes[0];
                 j < ptrSizes[i] * (offset_elements + fill_elements)
            ...
            hostptr[i] = (cl_ushort *)align_malloc(ptrSizes[i] * num_elements,
                                                   min_alignment);
            memset(hostptr[i], 0, ptrSizes[i] * num_elements);
        }
...
REGISTER_TEST(buffer_fill_char)
{
    ...
    for (n = 0; n < 8; n++)
    {
        ...
        for (i = 0; i < 5; i++)
        {
            ...
            inptr[i] = (cl_char *)align_malloc(ptrSizes[i] * num_elements,
                                               min_alignment);
            memset(inptr[i], 0, ptrSizes[i] * num_elements);
            for (j = ptrSizes[i] * offset_elements / ptrSizes[0];
                 j < ptrSizes[i] * (offset_elements + fill_elements)
            ...
            hostptr[i] = (cl_char *)align_malloc(ptrSizes[i] * num_elements,
                                                 min_alignment);
            memset(hostptr[i], 0, ptrSizes[i] * num_elements);
        }
...
REGISTER_TEST(buffer_fill_uchar)
{
    ...
    for (n = 0; n < 8; n++)
    {
        ...
        for (i = 0; i < 5; i++)
        {
            ...
            inptr[i] = (cl_uchar *)align_malloc(ptrSizes[i] * num_elements,
                                                min_alignment);
            memset(inptr[i], 0, ptrSizes[i] * num_elements);
            for (j = ptrSizes[i] * offset_elements / ptrSizes[0];
                 j < ptrSizes[i] * (offset_elements + fill_elements)
            ...
            hostptr[i] = (cl_uchar *)align_malloc(ptrSizes[i] * num_elements,
                                                  min_alignment);
            memset(hostptr[i], 0, ptrSizes[i] * num_elements);
        }
...
REGISTER_TEST(buffer_fill_long)
{
    ...
    for (n = 0; n < 8; n++)
    {
        ...
        for (i = 0; i < 5; i++)
        {
            ...
            inptr[i] = (cl_long *)align_malloc(ptrSizes[i] * num_elements,
                                               min_alignment);
            memset(inptr[i], 0, ptrSizes[i] * num_elements);
            for (j = ptrSizes[i] * offset_elements / ptrSizes[0];
                 j < ptrSizes[i] * (offset_elements + fill_elements)
            ...
            hostptr[i] = (cl_long *)align_malloc(ptrSizes[i] * num_elements,
                                                 min_alignment);
            memset(hostptr[i], 0, ptrSizes[i] * num_elements);
        }
...
REGISTER_TEST(buffer_fill_ulong)
{
    ...
    for (n = 0; n < 8; n++)
    {
        ...
        for (i = 0; i < 5; i++)
        {
            ...
            inptr[i] = (cl_ulong *)align_malloc(ptrSizes[i] * num_elements,
                                                min_alignment);
            memset(inptr[i], 0, ptrSizes[i] * num_elements);
            for (j = ptrSizes[i] * offset_elements / ptrSizes[0];
                 j < ptrSizes[i] * (offset_elements + fill_elements)
            ...
            hostptr[i] = (cl_ulong *)align_malloc(ptrSizes[i] * num_elements,
                                                  min_alignment);
            memset(hostptr[i], 0, ptrSizes[i] * num_elements);
        }
...
REGISTER_TEST(buffer_fill_float)
{
    ...
    for (n = 0; n < 8; n++)
    {
        ...
        for (i = 0; i < 5; i++)
        {
            ...
            inptr[i] = (cl_float *)align_malloc(ptrSizes[i] * num_elements,
                                                min_alignment);
            memset(inptr[i], 0, ptrSizes[i] * num_elements);
            for (j = ptrSizes[i] * offset_elements / ptrSizes[0];
                 j < ptrSizes[i] * (offset_elements + fill_elements)
            ...
            hostptr[i] = (cl_float *)align_malloc(ptrSizes[i] * num_elements,
                                                  min_alignment);
            memset(hostptr[i], 0, ptrSizes[i] * num_elements);
        }
