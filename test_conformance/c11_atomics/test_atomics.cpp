...
//     HostDataType>::OldValueCheck; using
//     CBasicTestMemOrderScope<HostAtomicType, HostDataType>::MemoryOrder; using
//     CBasicTestMemOrderScope<HostAtomicType, HostDataType>::MemoryScope; using
...
//            HostAtomicType, HostDataType>::ExecuteSingleTest(deviceID,
//            context,
//                                                             queue);
//    }
...
// static int test_atomic_store_generic(cl_device_id deviceID, cl_context
// context,
//                                      cl_command_queue queue, int
//                                      num_elements, bool useSVM)
//{
//     int error = 0;
...
//     CBasicTestStore<HOST_ATOMIC_ULONG, HOST_ULONG>
//     test_ulong(TYPE_ATOMIC_ULONG,
//                                                               useSVM);
//     EXECUTE_TEST(error,
//                  test_ulong.Execute(deviceID, context, queue, num_elements));
//     CBasicTestStore<HOST_ATOMIC_FLOAT, HOST_FLOAT>
//     test_float(TYPE_ATOMIC_FLOAT,
//                                                               useSVM);
//     EXECUTE_TEST(error,
...
//     EXECUTE_TEST(error,
//                  test_double.Execute(deviceID, context, queue,
//                  num_elements));
//     if (AtomicTypeInfo(TYPE_ATOMIC_SIZE_T).Size(deviceID) == 4)
//     {
//         CBasicTestStore<HOST_ATOMIC_INTPTR_T32, HOST_INTPTR_T32>
//         test_intptr_t(
...
//         EXECUTE_TEST(
//             error, test_size_t.Execute(deviceID, context, queue,
//             num_elements));
...
//     else
//     {
//         CBasicTestStore<HOST_ATOMIC_INTPTR_T64, HOST_INTPTR_T64>
//         test_intptr_t(
//             TYPE_ATOMIC_INTPTR_T, useSVM);
//         EXECUTE_TEST(
//             error,
...
// static int test_atomic_init_generic(cl_device_id deviceID, cl_context
// context,
//                                     cl_command_queue queue, int num_elements,
//                                     bool useSVM)
//{
//     int error = 0;
//     CBasicTestInit<HOST_ATOMIC_INT, HOST_INT> test_int(TYPE_ATOMIC_INT,
//     useSVM); EXECUTE_TEST(error,
//                  test_int.Execute(deviceID, context, queue, num_elements));
...
//     EXECUTE_TEST(error,
//                  test_long.Execute(deviceID, context, queue, num_elements));
//     CBasicTestInit<HOST_ATOMIC_ULONG, HOST_ULONG>
//     test_ulong(TYPE_ATOMIC_ULONG,
//                                                              useSVM);
//     EXECUTE_TEST(error,
//                  test_ulong.Execute(deviceID, context, queue, num_elements));
//     CBasicTestInit<HOST_ATOMIC_FLOAT, HOST_FLOAT>
//     test_float(TYPE_ATOMIC_FLOAT,
//                                                              useSVM);
//     EXECUTE_TEST(error,
//                  test_float.Execute(deviceID, context, queue, num_elements));
...
//     if (AtomicTypeInfo(TYPE_ATOMIC_SIZE_T).Size(deviceID) == 4)
//     {
//         CBasicTestInit<HOST_ATOMIC_INTPTR_T32, HOST_INTPTR_T32>
//         test_intptr_t(
//             TYPE_ATOMIC_INTPTR_T, useSVM);
//         EXECUTE_TEST(
//             error,
...
//     else
//     {
//         CBasicTestInit<HOST_ATOMIC_INTPTR_T64, HOST_INTPTR_T64>
//         test_intptr_t(
//             TYPE_ATOMIC_INTPTR_T, useSVM);
//         EXECUTE_TEST(
//             error,
...
//                                   HostDataType>::MemoryOrderScopeStr;
//     using CBasicTestMemOrderScope<HostAtomicType,
//     HostDataType>::MemoryScopeStr; using CBasicTest<HostAtomicType,
//     HostDataType>::CheckCapabilities; CBasicTestLoad(TExplicitAtomicType
//     dataType, bool useSVM)
//         : CBasicTestMemOrderScope<HostAtomicType, HostDataType>(dataType,
//                                                                 useSVM)
//     {
//         OldValueCheck(false);
...
// static int test_atomic_load_generic(cl_device_id deviceID, cl_context
// context,
//                                     cl_command_queue queue, int num_elements,
//                                     bool useSVM)
//{
//     int error = 0;
//     CBasicTestLoad<HOST_ATOMIC_INT, HOST_INT> test_int(TYPE_ATOMIC_INT,
//     useSVM); EXECUTE_TEST(error,
//                  test_int.Execute(deviceID, context, queue, num_elements));
...
//     EXECUTE_TEST(error,
//                  test_long.Execute(deviceID, context, queue, num_elements));
//     CBasicTestLoad<HOST_ATOMIC_ULONG, HOST_ULONG>
//     test_ulong(TYPE_ATOMIC_ULONG,
//                                                              useSVM);
//     EXECUTE_TEST(error,
//                  test_ulong.Execute(deviceID, context, queue, num_elements));
//     CBasicTestLoad<HOST_ATOMIC_FLOAT, HOST_FLOAT>
//     test_float(TYPE_ATOMIC_FLOAT,
//                                                              useSVM);
//     EXECUTE_TEST(error,
//                  test_float.Execute(deviceID, context, queue, num_elements));
...
//     if (AtomicTypeInfo(TYPE_ATOMIC_SIZE_T).Size(deviceID) == 4)
//     {
//         CBasicTestLoad<HOST_ATOMIC_INTPTR_T32, HOST_INTPTR_T32>
//         test_intptr_t(
//             TYPE_ATOMIC_INTPTR_T, useSVM);
//         EXECUTE_TEST(
//             error,
...
//     else
//     {
//         CBasicTestLoad<HOST_ATOMIC_INTPTR_T64, HOST_INTPTR_T64>
//         test_intptr_t(
//             TYPE_ATOMIC_INTPTR_T, useSVM);
//         EXECUTE_TEST(
//             error,
...
//     using CBasicTestMemOrderScope<HostAtomicType,
//     HostDataType>::OldValueCheck; using
//     CBasicTestMemOrderScope<HostAtomicType, HostDataType>::StartValue; using
//     CBasicTestMemOrderScope<HostAtomicType, HostDataType>::MemoryOrder; using
//     CBasicTestMemOrderScope<HostAtomicType,
//                                   HostDataType>::MemoryOrderScopeStr;
//     using CBasicTestMemOrderScope<HostAtomicType, HostDataType>::Iterations;
//     using CBasicTestMemOrderScope<HostAtomicType,
//     HostDataType>::IterationsStr; CBasicTestExchange(TExplicitAtomicType
//     dataType, bool useSVM)
//         : CBasicTestMemOrderScope<HostAtomicType, HostDataType>(dataType,
//                                                                 useSVM)
//     {
...
//                              HostDataType *oldValues)
//    {
//        oldValues[tid] = host_atomic_exchange(&destMemory[0],
//        (HostDataType)tid,
//                                              MemoryOrder());
...
//            cl_uint value;
//            if (i == threadCount)
//                value = (cl_uint)finalValues[0]; // additional value from
//                atomic
...
//            {
//                log_error(
//                    "ERROR: Reference value %u outside of valid range!
//                    (%u)\n", i, value);
//                correct = false;
//                return true;
//            }
...
//     EXECUTE_TEST(error,
//                  test_int.Execute(deviceID, context, queue, num_elements));
//     CBasicTestExchange<HOST_ATOMIC_UINT, HOST_UINT>
//     test_uint(TYPE_ATOMIC_UINT,
//                                                               useSVM);
//     EXECUTE_TEST(error,
//                  test_uint.Execute(deviceID, context, queue, num_elements));
//     CBasicTestExchange<HOST_ATOMIC_LONG, HOST_LONG>
//     test_long(TYPE_ATOMIC_LONG,
//                                                               useSVM);
//     EXECUTE_TEST(error,
//                  test_long.Execute(deviceID, context, queue, num_elements));
...
//     HostDataType>::OldValueCheck; using
//     CBasicTestMemOrder2Scope<HostAtomicType, HostDataType>::MemoryOrder;
//     using CBasicTestMemOrder2Scope<HostAtomicType,
//     HostDataType>::MemoryOrder2; using
//     CBasicTestMemOrder2Scope<HostAtomicType,
//                                    HostDataType>::MemoryOrderScope;
//     using CBasicTestMemOrder2Scope<HostAtomicType,
//     HostDataType>::MemoryScope; using
//     CBasicTestMemOrder2Scope<HostAtomicType, HostDataType>::DataType; using
//     CBasicTestMemOrder2Scope<HostAtomicType, HostDataType>::Iterations; using
//     CBasicTestMemOrder2Scope<HostAtomicType, HostDataType>::IterationsStr;
//     using CBasicTest<HostAtomicType, HostDataType>::CheckCapabilities;
...
//             return 0; // failure argument shall be no stronger than the
//             success
...
//{
//     int error = 0;
//     CBasicTestCompareStrong<HOST_ATOMIC_INT, HOST_INT>
//     test_int(TYPE_ATOMIC_INT,
//                                                                 useSVM);
//     EXECUTE_TEST(error,
//                  test_int.Execute(deviceID, context, queue, num_elements));
...
//{
//     return test_atomic_compare_exchange_strong_generic(device, context,
//     queue,
//                                                        num_elements, false);
// }
...
//     using CBasicTestCompareStrong<HostAtomicType,
//     HostDataType>::IterationsStr; CBasicTestCompareWeak(TExplicitAtomicType
//     dataType, bool useSVM)
...
//{
//     int error = 0;
//     CBasicTestCompareWeak<HOST_ATOMIC_INT, HOST_INT>
//     test_int(TYPE_ATOMIC_INT,
//                                                               useSVM);
//     EXECUTE_TEST(error,
//                  test_int.Execute(deviceID, context, queue, num_elements));
...
//             error,
//             test_uintptr_t.Execute(deviceID, context, queue, num_elements));
//         CBasicTestCompareWeak<HOST_ATOMIC_SIZE_T32, HOST_SIZE_T32>
//         test_size_t(
//             TYPE_ATOMIC_SIZE_T, useSVM);
//         EXECUTE_TEST(
//             error, test_size_t.Execute(deviceID, context, queue,
...
//             error,
//             test_uintptr_t.Execute(deviceID, context, queue, num_elements));
//         CBasicTestCompareWeak<HOST_ATOMIC_SIZE_T64, HOST_SIZE_T64>
//         test_size_t(
//             TYPE_ATOMIC_SIZE_T, useSVM);
//         EXECUTE_TEST(
//             error, test_size_t.Execute(deviceID, context, queue,
...
//     EXECUTE_TEST(error,
//                  test_int.Execute(deviceID, context, queue, num_elements));
//     CBasicTestFetchAdd<HOST_ATOMIC_UINT, HOST_UINT>
//     test_uint(TYPE_ATOMIC_UINT,
//                                                               useSVM);
//     EXECUTE_TEST(error,
//                  test_uint.Execute(deviceID, context, queue, num_elements));
//     CBasicTestFetchAdd<HOST_ATOMIC_LONG, HOST_LONG>
//     test_long(TYPE_ATOMIC_LONG,
//                                                               useSVM);
//     EXECUTE_TEST(error,
//                  test_long.Execute(deviceID, context, queue, num_elements));
...
//{
//     return test_atomic_fetch_add_generic(device, context, queue,
//     num_elements,
//                                          false);
// }
...
{
    int error = 0;
    //    CBasicTestFetchSub<HOST_ATOMIC_INT, HOST_INT>
    //    test_int(TYPE_ATOMIC_INT,
    //                                                           useSVM);
    //    EXECUTE_TEST(error,
    //                 test_int.Execute(deviceID, context, queue,
    //                 num_elements));
    //    CBasicTestFetchSub<HOST_ATOMIC_UINT, HOST_UINT>
    //    test_uint(TYPE_ATOMIC_UINT,
    //                                                              useSVM);
    //    EXECUTE_TEST(error,
    //                 test_uint.Execute(deviceID, context, queue,
    //                 num_elements));
    //    CBasicTestFetchSub<HOST_ATOMIC_LONG, HOST_LONG>
    //    test_long(TYPE_ATOMIC_LONG,
    //                                                              useSVM);
    //    EXECUTE_TEST(error,
    //                 test_long.Execute(deviceID, context, queue,
    //                 num_elements));
    //    CBasicTestFetchSub<HOST_ATOMIC_ULONG, HOST_ULONG> test_ulong(
    //        TYPE_ATOMIC_ULONG, useSVM);
    //    EXECUTE_TEST(error,
    //                 test_ulong.Execute(deviceID, context, queue,
    //                 num_elements));
    ...
    //        EXECUTE_TEST(
    //            error,
    //            test_intptr_t.Execute(deviceID, context, queue,
    //            num_elements));
    //        CBasicTestFetchSub<HOST_ATOMIC_UINTPTR_T32, HOST_UINTPTR_T32>
    //            test_uintptr_t(TYPE_ATOMIC_UINTPTR_T, useSVM);
    //        EXECUTE_TEST(
    //            error,
    //            test_uintptr_t.Execute(deviceID, context, queue,
    //            num_elements));
    //        CBasicTestFetchSub<HOST_ATOMIC_SIZE_T32, HOST_SIZE_T32>
    //        test_size_t(
    //            TYPE_ATOMIC_SIZE_T, useSVM);
    //        EXECUTE_TEST(
    //            error, test_size_t.Execute(deviceID, context, queue,
    ...
    //        EXECUTE_TEST(
    //            error,
    //            test_ptrdiff_t.Execute(deviceID, context, queue,
    //            num_elements));
    //    }
    //    else
    //    {
    ...
    //            test_uintptr_t.Execute(deviceID, context, queue,
    //            num_elements));
    //        CBasicTestFetchSub<HOST_ATOMIC_SIZE_T64, HOST_SIZE_T64>
    //        test_size_t(
    //            TYPE_ATOMIC_SIZE_T, useSVM);
    //        EXECUTE_TEST(
    //            error, test_size_t.Execute(deviceID, context, queue,
...
//     EXECUTE_TEST(error,
//                  test_int.Execute(deviceID, context, queue, num_elements));
//     CBasicTestFetchOr<HOST_ATOMIC_UINT, HOST_UINT>
//     test_uint(TYPE_ATOMIC_UINT,
//                                                              useSVM);
//     EXECUTE_TEST(error,
//                  test_uint.Execute(deviceID, context, queue, num_elements));
//     CBasicTestFetchOr<HOST_ATOMIC_LONG, HOST_LONG>
//     test_long(TYPE_ATOMIC_LONG,
//                                                              useSVM);
//     EXECUTE_TEST(error,
//                  test_long.Execute(deviceID, context, queue, num_elements));
...
//     EXECUTE_TEST(error,
//                  test_int.Execute(deviceID, context, queue, num_elements));
//     CBasicTestFetchXor<HOST_ATOMIC_UINT, HOST_UINT>
//     test_uint(TYPE_ATOMIC_UINT,
//                                                               useSVM);
//     EXECUTE_TEST(error,
//                  test_uint.Execute(deviceID, context, queue, num_elements));
//     CBasicTestFetchXor<HOST_ATOMIC_LONG, HOST_LONG>
//     test_long(TYPE_ATOMIC_LONG,
//                                                               useSVM);
//     EXECUTE_TEST(error,
//                  test_long.Execute(deviceID, context, queue, num_elements));
...
//{
//     return test_atomic_fetch_xor_generic(device, context, queue,
//     num_elements,
//                                          false);
// }
...
//     EXECUTE_TEST(error,
//                  test_int.Execute(deviceID, context, queue, num_elements));
//     CBasicTestFetchAnd<HOST_ATOMIC_UINT, HOST_UINT>
//     test_uint(TYPE_ATOMIC_UINT,
//                                                               useSVM);
//     EXECUTE_TEST(error,
//                  test_uint.Execute(deviceID, context, queue, num_elements));
//     CBasicTestFetchAnd<HOST_ATOMIC_LONG, HOST_LONG>
//     test_long(TYPE_ATOMIC_LONG,
//                                                               useSVM);
//     EXECUTE_TEST(error,
//                  test_long.Execute(deviceID, context, queue, num_elements));
...
//{
//     return test_atomic_fetch_and_generic(device, context, queue,
//     num_elements,
//                                          false);
// }
...
//     using CBasicTestMemOrderScope<HostAtomicType, HostDataType>::Iterations;
//     using CBasicTestMemOrderScope<HostAtomicType,
//     HostDataType>::IterationsStr; CBasicTestFetchOrAnd(TExplicitAtomicType
//     dataType, bool useSVM)
//         : CBasicTestMemOrderScope<HostAtomicType, HostDataType>(dataType,
//                                                                 useSVM)
//     {
...
//     // other bits are modified by other threads but it must not affect
//     current
//     // thread operation
//     virtual std::string ProgramCore()
//     {
...
//             error,
//             test_uintptr_t.Execute(deviceID, context, queue, num_elements));
//         CBasicTestFetchOrAnd<HOST_ATOMIC_SIZE_T32, HOST_SIZE_T32>
//         test_size_t(
//             TYPE_ATOMIC_SIZE_T, useSVM);
//         EXECUTE_TEST(
//             error, test_size_t.Execute(deviceID, context, queue,
...
//             error,
//             test_uintptr_t.Execute(deviceID, context, queue, num_elements));
//         CBasicTestFetchOrAnd<HOST_ATOMIC_SIZE_T64, HOST_SIZE_T64>
//         test_size_t(
//             TYPE_ATOMIC_SIZE_T, useSVM);
//         EXECUTE_TEST(
//             error, test_size_t.Execute(deviceID, context, queue,
...
//{
//     return test_atomic_fetch_orand_generic(device, context, queue,
//     num_elements,
//                                            false);
// }
...
//     using CBasicTestMemOrderScope<HostAtomicType, HostDataType>::Iterations;
//     using CBasicTestMemOrderScope<HostAtomicType,
//     HostDataType>::IterationsStr; CBasicTestFetchXor2(TExplicitAtomicType
//     dataType, bool useSVM)
//         : CBasicTestMemOrderScope<HostAtomicType, HostDataType>(dataType,
//                                                                 useSVM)
//     {
...
//     EXECUTE_TEST(error,
//                  test_int.Execute(deviceID, context, queue, num_elements));
//     CBasicTestFetchXor2<HOST_ATOMIC_UINT, HOST_UINT>
//     test_uint(TYPE_ATOMIC_UINT,
//                                                                useSVM);
//     EXECUTE_TEST(error,
//                  test_uint.Execute(deviceID, context, queue, num_elements));
//     CBasicTestFetchXor2<HOST_ATOMIC_LONG, HOST_LONG>
//     test_long(TYPE_ATOMIC_LONG,
//                                                                useSVM);
//     EXECUTE_TEST(error,
//                  test_long.Execute(deviceID, context, queue, num_elements));
...
//{
//     return test_atomic_fetch_xor2_generic(device, context, queue,
//     num_elements,
//                                           false);
// }
...
//                               HostDataType *oldValues)
//     {
//         oldValues[tid] = host_atomic_fetch_min(&destMemory[0],
//         oldValues[tid],
//                                                MemoryOrder());
//     }
//     virtual bool GenerateRefs(cl_uint threadCount, HostDataType
//     *startRefValues,
//                               MTdata d)
//     {
//         for (cl_uint i = 0; i < threadCount; i++)
...
//     EXECUTE_TEST(error,
//                  test_int.Execute(deviceID, context, queue, num_elements));
//     CBasicTestFetchMin<HOST_ATOMIC_UINT, HOST_UINT>
//     test_uint(TYPE_ATOMIC_UINT,
//                                                               useSVM);
//     EXECUTE_TEST(error,
//                  test_uint.Execute(deviceID, context, queue, num_elements));
//     CBasicTestFetchMin<HOST_ATOMIC_LONG, HOST_LONG>
//     test_long(TYPE_ATOMIC_LONG,
//                                                               useSVM);
//     EXECUTE_TEST(error,
//                  test_long.Execute(deviceID, context, queue, num_elements));
...
//{
//     return test_atomic_fetch_min_generic(device, context, queue,
//     num_elements,
//                                          false);
// }
...
//                               HostDataType *oldValues)
//     {
//         oldValues[tid] = host_atomic_fetch_max(&destMemory[0],
//         oldValues[tid],
//                                                MemoryOrder());
//     }
//     virtual bool GenerateRefs(cl_uint threadCount, HostDataType
...
//     EXECUTE_TEST(error,
//                  test_int.Execute(deviceID, context, queue, num_elements));
//     CBasicTestFetchMax<HOST_ATOMIC_UINT, HOST_UINT>
//     test_uint(TYPE_ATOMIC_UINT,
//                                                               useSVM);
//     EXECUTE_TEST(error,
//                  test_uint.Execute(deviceID, context, queue, num_elements));
//     CBasicTestFetchMax<HOST_ATOMIC_LONG, HOST_LONG>
//     test_long(TYPE_ATOMIC_LONG,
//                                                               useSVM);
//     EXECUTE_TEST(error,
//                  test_long.Execute(deviceID, context, queue, num_elements));
...
//{
//     return test_atomic_fetch_max_generic(device, context, queue,
//     num_elements,
//                                          false);
// }
...
//     HostDataType>::OldValueCheck; using
//     CBasicTestMemOrderScope<HostAtomicType, HostDataType>::MemoryOrder; using
//     CBasicTestMemOrderScope<HostAtomicType, HostDataType>::MemoryScopeStr;
//     using CBasicTestMemOrderScope<HostAtomicType,
//                                   HostDataType>::MemoryOrderScopeStr;
...
//         if (MemoryOrder() == MEMORY_ORDER_ACQUIRE) return
//         MEMORY_ORDER_RELAXED; if (MemoryOrder() == MEMORY_ORDER_ACQ_REL)
//         return MEMORY_ORDER_RELEASE; return MemoryOrder();
//     }
...
//        // case that LocalMemory() == false. Therefore we should skip this
//        test
...
//                         "atomic_scope_device "
//                         "which is optionally not supported on this
//                         device\n");
//                return 0; // skip test - not applicable
//            }
//        }
...
//                    // first visitor\n"
//        {
//            if (!host_atomic_flag_test_and_set(&destMemory[cnt],
//            MemoryOrder()))
//            {
//                cl_uint csIndex = cnt;
...
//                    stop = 1;
//                }
//                host_atomic_flag_clear(&destMemory[cnt],
//                MemoryOrderForClear());
//            }
//        }
//    }
...
//    {
//        correct = true;
//        /* We are expecting unique values from 0 to threadCount-1 (each
//        critical
...
// static int test_atomic_flag_generic(cl_device_id deviceID, cl_context
// context,
//                                     cl_command_queue queue, int num_elements,
//                                     bool useSVM)
//{
...
//     using CBasicTestMemOrderScope<HostAtomicType,
//     HostDataType>::UsedInFunction; using
//     CBasicTestMemOrderScope<HostAtomicType, HostDataType>::DataType; using
//     CBasicTestMemOrderScope<HostAtomicType,
//                                   HostDataType>::CurrentGroupSize;
//     using CBasicTestMemOrderScope<HostAtomicType, HostDataType>::UseSVM;
//     using CBasicTestMemOrderScope<HostAtomicType, HostDataType>::LocalMemory;
//     using CBasicTestMemOrderScope<HostAtomicType,
//     HostDataType>::LocalRefValues; CBasicTestFence(TExplicitAtomicType
//     dataType, bool useSVM)
//         : CBasicTestMemOrderScope<HostAtomicType, HostDataType>(dataType,
//                                                                 useSVM)
//     {
...
//                 return 2; // 1KB of local memory required by spec. Clamp
//                 group
...
//         testName += CBasicTest<HostAtomicType,
//         HostDataType>::SingleTestName(); testName += std::string(", ")
...
//     {
//         // Although memory_scope_all_devices doesn't mention SVM it is just
//         an
//         // alias for memory_scope_all_svm_devices.  So both scopes interact
//         with
...
//             // - repeats the above steps when both values are the same (and
//             less
//             // than 500000)
//             // - stores the last value read from other thread (in additional
//             // variable) At the end of execution at least one thread should
//             know
...
//         else
//         {
//             // Each thread modifies one of its non-atomic variables,
//             increments
//             // value of its atomic variable and reads values from another
//             thread
//             // in typical synchronizes-with scenario with:
//             // - non-atomic variable (at index A) modification (value change
//             // from 0 to A)
//             // - release operation (additional fence or within atomic) +
//             atomic
//             // variable modification (value A)
//             // - atomic variable read (value B) + acquire operation
//             (additional
...
//             else
//                 program += "    hisId =
//                 (hisId+threadCount-1)%threadCount;\n";
...
//                      && myValue
//                          < (HostDataType)NumNonAtomicVariablesPerThread() -
//                          1);
//             if (hisAtomicValue != hisValue)
//             { // fail
//                 host_atomic_store<HostAtomicType, HostDataType>(
...
//                     else
//                     {
//                         // slower thread (in total order of seq_cst
//                         operations)
...
//                        // counter value
//                        if (myValue == hisRealValue) // forbidden result -
//                        fence
//                                                     // doesn't work
//                        {
...
// static int test_atomic_fence_generic(cl_device_id deviceID, cl_context
// context,
//                                      cl_command_queue queue, int
//                                      num_elements, bool useSVM)
//{
...
//     EXECUTE_TEST(error,
//                  test_long.Execute(deviceID, context, queue, num_elements));
//     CBasicTestFence<HOST_ATOMIC_ULONG, HOST_ULONG>
//     test_ulong(TYPE_ATOMIC_ULONG,
//                                                               useSVM);
//     EXECUTE_TEST(error,
//                  test_ulong.Execute(deviceID, context, queue, num_elements));
//     if (AtomicTypeInfo(TYPE_ATOMIC_SIZE_T).Size(deviceID) == 4)
//     {
//         CBasicTestFence<HOST_ATOMIC_INTPTR_T32, HOST_INTPTR_T32>
//         test_intptr_t(
//             TYPE_ATOMIC_INTPTR_T, useSVM);
//         EXECUTE_TEST(
//             error,
...
//     else
//     {
//         CBasicTestFence<HOST_ATOMIC_INTPTR_T64, HOST_INTPTR_T64>
//         test_intptr_t(
//             TYPE_ATOMIC_INTPTR_T, useSVM);
//         EXECUTE_TEST(
//             error,
