...
static int test_degrees_double(cl_device_id device, cl_context context,
...
const char *degrees16_kernel_code = "__kernel void test_degrees16(__global "
...
static int verify_degrees(float *inptr, float *outptr, int n)
{
...
const char *degrees_kernel_code_double =
    ...
    "__kernel void test_degrees_double(__global double *src, __global double "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
...
const char *degrees2_kernel_code_double =
    "#pragma OPENCL EXTENSION cl_khr_fp64 : enable\n"
    "__kernel void test_degrees2_double(__global double2 *src, __global "
    "double2 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
...
const char *degrees4_kernel_code_double =
    "#pragma OPENCL EXTENSION cl_khr_fp64 : enable\n"
    "__kernel void test_degrees4_double(__global double4 *src, __global "
    "double4 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
...
const char *degrees8_kernel_code_double =
    "#pragma OPENCL EXTENSION cl_khr_fp64 : enable\n"
    "__kernel void test_degrees8_double(__global double8 *src, __global "
    "double8 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
...
const char *degrees16_kernel_code_double =
    "#pragma OPENCL EXTENSION cl_khr_fp64 : enable\n"
    "__kernel void test_degrees16_double(__global double16 *src, __global "
    "double16 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
...
const char *degrees3_kernel_code_double =
    "#pragma OPENCL EXTENSION cl_khr_fp64 : enable\n"
    "__kernel void test_degrees3_double(__global double *src, __global double "
    "*dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
...
static int verify_degrees_double(double *inptr, double *outptr, int n)
{
    float error, max_error = 0.0f;
    double r, max_val = NAN;
    int i, j, max_index = 0;
                               ...
                               cl_command_queue queue, int n_elems)
{
    ...
    err = create_single_kernel_helper(context, &program[0], &kernel[0], 1,
                                      &degrees_kernel_code_double,
                                      "test_degrees_double");
    if (err) return -1;
    err = create_single_kernel_helper(context, &program[1], &kernel[1], 1,
                                      &degrees2_kernel_code_double,
                                      "test_degrees2_double");
    if (err) return -1;
    err = create_single_kernel_helper(context, &program[2], &kernel[2], 1,
                                      &degrees4_kernel_code_double,
                                      "test_degrees4_double");
    if (err) return -1;
    err = create_single_kernel_helper(context, &program[3], &kernel[3], 1,
                                      &degrees8_kernel_code_double,
                                      "test_degrees8_double");
    if (err) return -1;
    err = create_single_kernel_helper(context, &program[4], &kernel[4], 1,
                                      &degrees16_kernel_code_double,
                                      "test_degrees16_double");
    if (err) return -1;
    err = create_single_kernel_helper(context, &program[5], &kernel[5], 1,
                                      &degrees3_kernel_code_double,
