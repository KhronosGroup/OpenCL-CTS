...
static int verify_fmin(float *inptrA, float *inptrB, float *outptr, int n,
                       int veclen)
{
    float r;
    int i, j;
               ...
               int n_elems)
{
    ...
    for (i = 0; i < kTotalVecCount; i++)
    {
        ...
        if (verify_fmin(input_ptr[0], input_ptr[1], output_ptr,
