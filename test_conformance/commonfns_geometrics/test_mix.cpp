...
float verify_mix(float *inptrA, float *inptrB, float *inptrC, float *outptr,
                 int n)
{
             ...
             int num_elements)
{
    ...
    max_err = verify_mix(input_ptr[0], input_ptr[1], input_ptr[2], output_ptr,
                         num_elements);
    if (max_err > MAX_ERR)
    {
