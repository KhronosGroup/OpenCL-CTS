...
static int test_step_double(cl_device_id device, cl_context context,
                            cl_command_queue queue, int n_elems);


const char *step_kernel_code = "__kernel void test_step(__global float *srcA, "
                               "__global float *srcB, __global float *dst)\n"
                               "{\n"
...
int verify_step(float *inptrA, float *inptrB, float *outptr, int n)
{
    float r;
    int i;
              ...
              int n_elems)
{
    ...
    if (!is_extension_available(device, "cl_khr_fp64")) return 0;
...
const char *step2_kernel_code_double =
    "#pragma OPENCL EXTENSION cl_khr_fp64 : enable\n"
    "__kernel void test_step2_double(__global double2 *srcA, __global double2 "
...
const char *step4_kernel_code_double =
    "#pragma OPENCL EXTENSION cl_khr_fp64 : enable\n"
    "__kernel void test_step4_double(__global double4 *srcA, __global double4 "
...
const char *step8_kernel_code_double =
    "#pragma OPENCL EXTENSION cl_khr_fp64 : enable\n"
    "__kernel void test_step8_double(__global double8 *srcA, __global double8 "
...
const char *step16_kernel_code_double =
    "#pragma OPENCL EXTENSION cl_khr_fp64 : enable\n"
    "__kernel void test_step16_double(__global double16 *srcA, __global "
    "double16 *srcB, __global double16 *dst)\n"
    "{\n"
    "    int  tid = get_global_id(0);\n"
    "\n"
    "    dst[tid] = step(srcA[tid], srcB[tid]);\n"
...
int verify_step_double(double *inptrA, double *inptrB, double *outptr, int n)
{
    double r;
    int i;
