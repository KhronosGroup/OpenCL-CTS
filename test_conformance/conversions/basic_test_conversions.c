...
static void char2uchar_sat( void *out, void *in){ cl_char c = ((char*) in)[0]; ((cl_uchar*) out)[0] = c < 0 ? 0 : c; }
static void char2ushort_sat( void *out, void *in){ cl_char c = ((char*) in)[0]; ((cl_ushort*) out)[0] = c < 0 ? 0 : c; }
static void char2short_sat( void *out, void *in){ ((cl_short*) out)[0] = ((cl_char*) in)[0]; }
static void char2uint_sat( void *out, void *in){ cl_char c = ((char*) in)[0]; ((cl_uint*) out)[0] = c < 0 ? 0 : c; }
...
static void char2long_sat( void *out, void *in){ ((cl_long*) out)[0] = ((char*) in)[0]; }
...
static void float2int_sat( void *out, void *in){ ((cl_int*) out)[0] = (cl_int) CLAMP( INT_MIN, lrintf_clamped(((cl_float*) in)[0]), CL_INT_MAX ); }
...
static void double2int_sat( void *out, void *in){ ((cl_int*) out)[0] = (cl_int) CLAMP( INT_MIN, lrint_clamped(((cl_double*) in)[0]), CL_INT_MAX ); }
...
static void long2int_sat( void *out, void *in){ cl_long u = ((cl_long*) in)[0]; ((cl_int*) out)[0] = (int) CLAMP( INT_MIN, u, CL_INT_MAX ); }
...
void init_uint( void *out, SaturationMode UNUSED sat, RoundingMode UNUSED round, Type UNUSED destType, uint64_t start, int count, MTdata UNUSED d )
{
...
void init_int( void *out, SaturationMode UNUSED sat, RoundingMode UNUSED round, Type UNUSED destType, uint64_t start, int count, MTdata UNUSED d )
{
    int *o = (int *)out;
    int i;
