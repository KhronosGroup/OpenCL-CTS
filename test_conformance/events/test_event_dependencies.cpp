                                                ...
                                                int test_enqueue_wait_for_events, int test_barrier, int use_waitlist, int use_marker)
{
    ...
    if (two_queues) {
        ...
        if (two_devices)
        {
            ...
            queueWrappers[0] = clCreateCommandQueue(context_to_use, two_device_ids[0], (cl_command_queue_properties)props, &error);
            test_error(error, "clCreateCommandQueue for first queue on first device failed.");
            queueWrappers[1] = clCreateCommandQueue(context_to_use, two_device_ids[1], (cl_command_queue_properties)props, &error);
        ...
        else
        {
            ...
            queueWrappers[0] = clCreateCommandQueue(context_to_use, deviceID, (cl_command_queue_properties)props, &error);
            test_error(error, "clCreateCommandQueue for first queue failed.");
            queueWrappers[1] = clCreateCommandQueue(context_to_use, deviceID, (cl_command_queue_properties)props, &error);
