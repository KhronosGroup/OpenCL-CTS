...
test_definition test_list[] = {
    ...
    ADD_TEST(fill_image_khr),
    ADD_TEST(fill_buffer_khr),
    ADD_TEST(copy_image_khr),
    ADD_TEST(copy_buffer_khr),
    ADD_TEST(copy_buffer_to_image_khr),
    ADD_TEST(copy_image_to_buffer_khr),
    ADD_TEST(copy_buffer_rect_khr),
    ADD_TEST(barrier_wait_list_khr),
};
