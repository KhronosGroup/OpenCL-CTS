...
int test_negative_fill_immutable_image(cl_device_id device, cl_context context,
...
int test_negative_fill_immutable_buffer(cl_device_id device, cl_context context,
                                        cl_command_queue queue,
                                        int num_elements)
{
