...
extern int test_negative_get_command_buffer_info_context(cl_device_id device,
                                                         ...
                                                         cl_command_queue queue,
                                                         int num_elements);
extern int test_negative_command_buffer_command_fill_queue_not_null(
    cl_device_id device, cl_context context, cl_command_queue queue,
    int num_elements);
extern int test_negative_command_buffer_command_fill_context_not_same(
    cl_device_id device, cl_context context, cl_command_queue queue,
    int num_elements);
extern int
test_negative_command_buffer_command_fill_sync_points_null_or_num_zero(
    cl_device_id device, cl_context context, cl_command_queue queue,
    int num_elements);
extern int test_negative_command_buffer_command_fill_invalid_command_buffer(
    cl_device_id device, cl_context context, cl_command_queue queue,
    int num_elements);
extern int test_negative_command_buffer_command_fill_finalized_command_buffer(
    cl_device_id device, cl_context context, cl_command_queue queue,
    int num_elements);
extern int test_negative_command_buffer_command_fill_mutable_handle_not_null(
    cl_device_id device, cl_context context, cl_command_queue queue,
    int num_elements);
