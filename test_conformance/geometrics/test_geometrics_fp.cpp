    ...
    : GeomTestBase(dt, name, ulp)
{
    ...
    if (std::is_same<T, half>::value)
    {
        trickyValues = { (half)HFF(-CL_HALF_EPSILON),
                         (half)HFF(CL_HALF_EPSILON),
                         (half)HFF(MAKE_HEX_FLOAT(0x1.0p7f, 0x1L, 7)),
                         (half)HFF(MAKE_HEX_FLOAT(0x1.8p7f, 0x18L, 3)),
                         (half)HFF(MAKE_HEX_FLOAT(0x1.0p8f, 0x1L, 8)),
                         (half)HFF(MAKE_HEX_FLOAT(-0x1.0p7f, -0x1L, 7)),
                         (half)HFF(MAKE_HEX_FLOAT(-0x1.8p-7f, -0x18L, -11)),
                         (half)HFF(MAKE_HEX_FLOAT(-0x1.0p8f, -0x1L, 8)),
                         (half)HFF(MAKE_HEX_FLOAT(0x1.0p-7f, 0x1L, -7)),
                         (half)HFF(MAKE_HEX_FLOAT(0x1.8p-7f, 0x18L, -11)),
                         (half)HFF(MAKE_HEX_FLOAT(0x1.0p-8f, 0x1L, -8)),
                         (half)HFF(MAKE_HEX_FLOAT(-0x1.0p-7f, -0x1L, -7)),
                         (half)HFF(MAKE_HEX_FLOAT(-0x1.8p-7f, -0x18L, -11)),
                         (half)HFF(MAKE_HEX_FLOAT(-0x1.0p-8f, -0x1L, -8)),
                         (half)HFF(HTF(CL_HALF_MAX) / 2.f),
                         (half)HFF(-HTF(CL_HALF_MAX) / 2.f),
                         (half)HALF_P_INF,
                         (half)HALF_N_INF,
                         (half)HFF(0.f),
    ...
    {
        trickyValues = { (float)-FLT_EPSILON,
                         (float)FLT_EPSILON,
                         (float)MAKE_HEX_FLOAT(0x1.0p63f, 0x1L, 63),
                         (float)MAKE_HEX_FLOAT(0x1.8p63f, 0x18L, 59),
                         (float)MAKE_HEX_FLOAT(0x1.0p64f, 0x1L, 64),
                         (float)MAKE_HEX_FLOAT(-0x1.0p63f, -0x1L, 63),
                         (float)MAKE_HEX_FLOAT(-0x1.8p-63f, -0x18L, -67),
                         (float)MAKE_HEX_FLOAT(-0x1.0p64f, -0x1L, 64),
                         (float)MAKE_HEX_FLOAT(0x1.0p-63f, 0x1L, -63),
                         (float)MAKE_HEX_FLOAT(0x1.8p-63f, 0x18L, -67),
                         (float)MAKE_HEX_FLOAT(0x1.0p-64f, 0x1L, -64),
                         (float)MAKE_HEX_FLOAT(-0x1.0p-63f, -0x1L, -63),
                         (float)MAKE_HEX_FLOAT(-0x1.8p-63f, -0x18L, -67),
                         (float)MAKE_HEX_FLOAT(-0x1.0p-64f, -0x1L, -64),
                         (float)FLT_MAX / 2.f,
    ...
    {
        trickyValues = { (double)-FLT_EPSILON,
                         (double)FLT_EPSILON,
                         (double)MAKE_HEX_DOUBLE(0x1.0p511, 0x1L, 511),
                         (double)MAKE_HEX_DOUBLE(0x1.8p511, 0x18L, 507),
                         (double)MAKE_HEX_DOUBLE(0x1.0p512, 0x1L, 512),
                         (double)MAKE_HEX_DOUBLE(-0x1.0p511, -0x1L, 511),
                         (double)MAKE_HEX_DOUBLE(-0x1.8p-511, -0x18L, -515),
                         (double)MAKE_HEX_DOUBLE(-0x1.0p512, -0x1L, 512),
                         (double)MAKE_HEX_DOUBLE(0x1.0p-511, 0x1L, -511),
                         (double)MAKE_HEX_DOUBLE(0x1.8p-511, 0x18L, -515),
                         (double)MAKE_HEX_DOUBLE(0x1.0p-512, 0x1L, -512),
                         (double)MAKE_HEX_DOUBLE(-0x1.0p-511, -0x1L, -511),
                         (double)MAKE_HEX_DOUBLE(-0x1.8p-511, -0x18L, -515),
                         (double)MAKE_HEX_DOUBLE(-0x1.0p-512, -0x1L, -512),
                         (double)DBL_MAX / 2.,
