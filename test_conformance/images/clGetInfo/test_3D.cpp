...
int test_get_image_info_3D( cl_device_id device, cl_context context, cl_image_format *format, cl_mem_flags flags )
{
    ...
    maxAllocSize = get_device_info_max_mem_alloc_size(device, MAX_DEVICE_MEMORY_SIZE_DIVISOR);
    memSize = get_device_info_global_mem_size(device, MAX_DEVICE_MEMORY_SIZE_DIVISOR);
