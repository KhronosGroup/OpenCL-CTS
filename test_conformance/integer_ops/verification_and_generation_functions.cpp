...
{
    static const cl_ushort specialCaseList[] = { 0, (cl_ushort)-1, 1, CL_SHRT_MAX, CL_SHRT_MAX + 1, CL_USHRT_MAX };
    int            j;
...
{
    static const cl_uchar specialCaseList[] = { 0, (cl_uchar)-1, 1, CL_CHAR_MAX, CL_CHAR_MAX + 1, CL_UCHAR_MAX };
    int            j;
