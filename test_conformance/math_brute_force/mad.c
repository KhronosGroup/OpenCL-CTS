...
*/
    ...
    for( i = 0; i < (1ULL<<32); i += step )
    {
        ...
        if( (error = clEnqueueWriteBuffer(gQueue, gInBuffer3, CL_FALSE, 0, BUFFER_SIZE, gIn3, 0, NULL, NULL) ))
        {
...
*/
    ...
    {
        if( gWimpyMode )
            vlog( "Wimp pass without correctness checking." );
        else
            vlog( "passed without correctness checking." );
    }
