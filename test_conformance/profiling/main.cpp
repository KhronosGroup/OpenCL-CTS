...
test_definition test_list[] = {
    ...
    ADD_TEST(execute),           ADD_TEST(enqueue_marker),
    ADD_TEST(enqueue_barrier),
                ...
                cl_ulong commandStart, cl_ulong commandEnd, cl_device_id device)
{
    ...
    log_info("CL_PROFILING_COMMAND_QUEUED: %llu CL_PROFILING_COMMAND_SUBMIT: "
             "%llu CL_PROFILING_COMMAND_START: %llu CL_PROFILING_COMMAND_END: "
             "%llu CL_DEVICE_PROFILING_TIMER_RESOLUTION: %ld\n",
