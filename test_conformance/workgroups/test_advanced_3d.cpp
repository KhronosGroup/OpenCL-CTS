...
int test_non_uniform_3d_basic(cl_device_id device, cl_context context,
...
int test_non_uniform_3d_atomics(cl_device_id device, cl_context context,
                                cl_command_queue queue, int num_elements)
{
    SubTestExecutor exec(device, context, queue);
...
int test_non_uniform_3d_barriers(cl_device_id device, cl_context context,
                                 cl_command_queue queue, int num_elements)
{
    SubTestExecutor exec(device, context, queue);
